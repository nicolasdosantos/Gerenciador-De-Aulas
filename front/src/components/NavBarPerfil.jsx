        ...
        <div className={style5.principal}>
            ...
            {!exibirPerfil && (
                <div className={style5.logoNav}>
                    <button onClick={() => {menuPerfil(); togglePerfil(); toggleBarraLateral(); }} className={style5.botaoImgLogo}>
            ...
            {exibirPerfil && (
                <div style={{left: animacaoPerfil ? '0px' : '-300px'}} className={style5.principalPerfil}>
                    ...
                    <div className={style5.prograList} ref={prograListRef} style={{overflowX: 'auto', display: showPrograList ? 'block' : 'none'}}>

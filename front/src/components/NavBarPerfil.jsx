...
function NavBarPerfil({ showPrograList, isCalendario }) {
    ...
    const [hamburguerPerfil, setHamburguerPerfil] = useState(true)
    function menuPerfil(){
        setHamburguerPerfil(!hamburguerPerfil);
    }

    return (
        <div>
            <button className={style5.botaoMenuPerfil} onClick={menuPerfil}>
                Hamburguer
            </button>

            <div className={style5.principal} style={{right: hamburguerPerfil ? '0px' : '-400px'}}>
